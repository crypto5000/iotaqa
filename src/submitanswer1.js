$(document).ready(function() {
    ...
    try{
        ...
        submitAnswer(answer,viewAddress,bountyAddress);
    ...
    function submitAnswer(answer,viewAddress,bountyAddress) {
        ...
        let tag = "IOTAQNAAAAAAAAAAAAAAAAAAAAA";                       
        let depth = 10;
        let weight = 14;
        ...
        const localAttachToTangle = function(trunkTransaction, branchTransaction, minWeightMagnitude, trytes, callback) {
            ...
            $('#loadingText').html("Attaching Answer to Tangle");		
        ...
        function sendMessages(viewAddress) {
            ...
            iota.api.sendTransfer(seed, generateDepth(), weight, transfers, function(error, success){
                ...
                $('#loading').hide();
                $('#loadingText').html("Success. Answer is Now In the Tangle.");	
                $('#breakGap').hide();	
                $('#displaySuccess').show();	
